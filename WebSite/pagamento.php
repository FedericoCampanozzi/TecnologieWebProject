                        ...
                        <div class="table-responsive">
                            <table id="tbl_carrello_utente" style="width:100%;" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    echo "
                                            <tr>
                                                <td colspan=\"4\" style=\"text-aling:center;\"> Totale : </td>
                                                <td> " . $tot . " &euro; </td>
                                            </tr>";
                                    ?>
                                </tbody>
                    ...
                    <div class="container">
                        <form action="utils/insert.php" method="post">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="useContanti" id="useContanti" value="0" checked>
                                <label class="form-check-label" for="useContanti">Contanti (alla consegna)</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="useContanti" value="1">

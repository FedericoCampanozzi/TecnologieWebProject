                    ...
                    <div class="container">
                        <form action="utils/insert.php" method="post">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="useContanti" id="usaContanti" value="0" checked>
                                <label class="form-check-label" for="useContanti">Contanti (alla consegna)</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="useContanti" id="usaCarte" value="1">
